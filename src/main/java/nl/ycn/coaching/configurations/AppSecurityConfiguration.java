...
public class AppSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception{
        ...
        appUserService.registerUser("alex","Alex", "van Manen", "superalex3@hotmail.nl", encoder.encode("hallo"), "TRAINEE", true, true, Date.valueOf("1997-01-01") ,"3000PP", "Bobhof", "1", "Bobdam", "Bobland", "112", "devops-02-19");
