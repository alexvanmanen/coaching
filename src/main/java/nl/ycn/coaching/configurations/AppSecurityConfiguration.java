...
public class AppSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception{
        ...
        appUserService.registerUser("alex","Alex", "van Manen", "alex@vanmanenit.nl", encoder.encode("hallo"), "TRAINEE", true, false, Date.valueOf("1997-01-01") ,"3000PP", "Bobhof", "1", "Bobdam", "Bobland", "112", "devops 1");
        appUserService.registerUser("jurre","Jurre", "Wempe", "jurrewempe@hotmail.com", encoder.encode("hallo"), "TRAINEE", true, false, Date.valueOf("2000-01-01") ,"3000PP", "Lansiershof", "6", "Sassenheim", "The Netherlands", "+316-52498741", "devops 1");
        appUserService.registerUser("jeanine","Jeanine", "van Dongen", "jeaninevdongen@gmail.com", encoder.encode("hallo"), "TRAINEE", true, false, Date.valueOf("1997-01-01") ,"2216TL", "Ter Beek", "4", "Lisse", "The Netherlands", "+316-45389142", "devops 1");
