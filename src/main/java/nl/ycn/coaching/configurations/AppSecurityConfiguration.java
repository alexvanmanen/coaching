...
public class AppSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception{
        ...
        appUserService.registerUser("jeanine","Jeanine", "van Dongen", "jeaninevdongen@gmail.com", encoder.encode("hallo"), "TRAINEE", true, false, Date.valueOf("1997-01-01") ,"2216TL", "Ter Beek", "4", "Lisse", "The Netherlands", "+316-45389142", "devops-02-19");
